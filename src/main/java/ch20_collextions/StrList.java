...
public class StrList {
    public static void main(String[] args) {
        ...
        // 출력
        System.out.println(strArray1);                      // 참조자료형이라서 주소값이 출렫된빈다.
        ...
        System.out.println(removed2 + "의 삭제여부 : " + removed2);
        System.out.println(strList1);
        ...
        // python 언어 java언어 javascript 언어 c# 언어로 출력될 수 있도록 작성하시오
        // 참고 : strList1.leghths는 안먹습니다. - > List는 size를 씁니다.(근데 필드가 아니라 메서등입니다.)

        for( int i = 0 ; i <strList1.size(); i++){
            System.out.println(strList1.get(i)+ " 언어 ");
        }
        // 이상의 코드에서 알수 있는 점은
        // 배열과는 달리 한계값을 출력하기 휘해서 리스트 명.size()를 사용
        // 출력할 때도 리스트 명.get(i)를 썼다는 점입니다.
        // 배열의 경우는 뱌ㅐ열명.length
        // 배열명[i]를 사용했습니다.
