...
/*
    ...
    boolesan : true / false를 구분하는 자료형

    AND(&&) : 곱 연산자 T x T = T / T x F = F / F x F = F -> 하나라도 false라면 false
    OR(||) : 합 연산자 T + T= T / T + F = T / F + F = F -> 하나라도 true람녀 true
    NOT(!) true 갑을 false로, false를 true로 역전시키는 연산자
 */
public class Operation02 {
    public static void main(String[] args) {
        ...
        System.out.println("10 / 3연산의 나머지는 0이다? : " + result9);
